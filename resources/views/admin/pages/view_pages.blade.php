                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="min-width: 80px!important"> 
                                        <a class="btn btn-outline-primary btn-sm" href="{{ url('/admin/edit-cms/'.$page->id) }}" title="Edit Product"><em class="far fa-edit"></em></a>
                                        {{-- <span>
                                            <!-- Button trigger modal -->
                                            <button type="button" class="btn btn-outline-info btn-sm" data-toggle="modal" data-target="#Modal{{$page->id}}" title="View Details">
                                                ...
                                                <div class="modal-dialog" role="document ">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Details of: {{$page->title}} </h5>
                                        ...
                                        <a class="btn btn-outline-danger btn-sm deleteRecord"<?php /* href="{{ url('/admin/delete-cms/'.$page->id) }}" */?> rel="{{$page->id}}" rel1="delete-cms" title="Delete Product" href="javascript:" ><em class="far fa-trash-alt"></em></a>
                                    </td> 
