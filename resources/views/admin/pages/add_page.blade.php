...
<!-- Bread crumb and right sidebar toggle -->
            ...
            <div class="container-fluid">
                ...
                <form enctype="multipart/form-data" class="form-horizontal" action="{{ url('/admin/add-cms') }}" method="post" name="add_cms" id="add_cms"> {{csrf_field()}}
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" name="description" id="description" required="true"  cols="30" rows="10"></textarea>
                                        </div>
                                    </div>
                                    {{-- Laravel texteditor --}}
                                    <div class="form-group row">
