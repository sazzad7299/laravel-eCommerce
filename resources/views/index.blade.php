            ...
            <div class="col-sm-12">
                <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <ol class="carousel-indicators">
                            ...
                            <li data-target="#slider-carousel" data-slide-to="<?php echo $key ?>"  class="@if($key==0) active @endif"></li>
                            @endforeach
                    ...
                    <div class="carousel-inner">
                        @foreach($sliders as $key => $slider)
                            ...
                            <div class="item @if($key==0) active @endif">
                                ...
                                <img src="{{asset('img/banners/'.$slider->image)  }}" alt="">
                                <div class="col-sm-6 @if($slider->position=="0") middle @elseif($slider->position=="4") bottom-right @elseif($slider->position=="1") top-left @elseif($slider->position=="2") top-right @elseif($slider->position=="3") bottom-left @endif" >
                                    <h1>{{ $slider->title }}</h1>
                                    <h2></h2>
                                    <p>{{ $slider->link }}</p>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                ...
                <div align="center">{{ $allProduct->links() }}</div>
